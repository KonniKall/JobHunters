...
urlpatterns = [
    ...
    path(
        "sign-out/",
        auth_views.LogoutView.as_view(template_name="users/sign-out.html"),
        name="sign-out",
    ),
